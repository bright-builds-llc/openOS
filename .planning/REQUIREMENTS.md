...
- [x] **NOTES-02**: User can create and edit structured local notes with headings or sections.
- [x] **NOTES-03**: User can create and update checklist or list content inside a local note.
- [x] **NOTES-04**: User can search structured note content and see useful previews generated from formatted text.
- [x] **NOTES-05**: User can return to Notes and resume the last meaningful folder, note, and edit context after navigating home or reloading.
...
| NOTES-02 | Phase 25 | Complete |
| NOTES-03 | Phase 25 | Complete |
| NOTES-04 | Phase 24 | Complete |
| NOTES-05 | Phase 25 | Complete |
